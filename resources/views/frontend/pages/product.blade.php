                ...
                <div class="row">
                            ...
                            <ul class="product__small__images" role="tablist">
                                <li role="presentation" class="pot-small-img active">
                                    <a href="#img-tab-0" role="tab" data-toggle="tab">
                                        <img style="width: 80px;object-fit: cover" src="{{$data->product_image}}"
                                             alt="small-image">
                                    </a>
                                </li>
                                @foreach ($dataProductImages as $item)
                                    <li role="presentation" class="pot-small-img">
                                        <a href="#img-tab-{{$item->image_id}}" role="tab" data-toggle="tab">
                                            <img style="width: 80px;object-fit: cover" src="{{$item->image_name}}"
                                                 alt="small-image">
                                        </a>
                                    </li>
                                @endforeach
                    ...
                    <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                        <div class="ht__product__dtl">
                            ...
                            <ul class="rating">
                                <li>Giảm {{$data->product_sale}}%</li>
                                <br>
                            </ul>
                            <ul class="pro__prize">

                                <li class="old__prize">{{number_format($data->product_price_sell)}} VNĐ</li>
                                <li>{{number_format($product_price_sale = $data->product_price_sell - ($data->product_price_sell/100 * $data->product_sale))}}
                                    VNĐ
                                </li>
                            </ul>
                            <br>
                            ...
                            <div class="pro__tab__content__inner">
                                <div class="ht__pro__desc">
                                    <form>
                                        ...
                                        @endphp
                                        <input type="hidden" class="cart_product_{{$data->product_id}}"
                                               value="{{$data->product_name}}">
                                        <input type="hidden" class="cart_price_{{$data->product_id}}"
                                               value="{{$data->product_price_buy}}">
                                        <input type="hidden" class="cart_price_sale_{{$data->product_id}}"
                                               value="{{$product_price_sale}}">
                                        <input type="hidden" class="cart_amount_{{$data->product_id}}"
                                               value="{{$data->product_amount}}">
                                        <input type="hidden" class="cart_quantity_{{$data->product_id}}" value="1">
                                        <input type="hidden" class="cart_image_{{$data->product_id}}"
                                    ...
                                    <div class="sin__desc align--left">
                                        ...
                                        <ul class="pro__cat__list">
                                            <li>
                                                <a href="/shop/category/{{$data->category_id}}">{{$data->category->category_name}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="sin__desc align--left">
                                        ...
                                        <ul class="pro__cat__list">
                                            <li>
                                                <a href="/shop/brand/{{$data->brand_id}}">{{$data->brand->brand_name}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="sin__desc">
                                        <ul class="payment__btn">
                                            <li style="display: flex;">
                                                @if ($data->product_amount != 0)
                                                    <button class="add_to_cart btn"
                                                            style="width:200px; margin-right: 20px"
                                                            data-id="{{$item->product_id}}" type="button">Thêm Vào
                                                        Giỏ
                                                        Hàng <i class="icon-handbag icons"></i></button>
                                                @endif
                                    ...
                                    <div class="sin__desc product__share__link">
                                        ...
                                        <ul class="pro__share">
                                            ...
                                            <li><a href="#" target="_blank"><i
                                                        class="icon-social-linkedin icons"></i></a>
                                            </li>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <ul class="pro__details__tab" role="tablist">
                        ...
                        <li role="presentation" class="review"><a href="#review" role="tab" data-toggle="tab">Bình
                                Luận</a></li>

                        <li role="presentation" style="" class="info"><a href="#info" role="tab" data-toggle="tab">Bài viết
                                đánh giá</a></li>
                ...
                <div class="col-xs-12">
                    <div class="ht__pro__details__content">
                        ...
                        <div role="tabpanel" id="info" class="pro__single__content tab-pane fade  ">
                            <div style="text-align: center;line-height: 150%" class="pro__tab__content__inner">
                                <div class="ht__pro__desc">
                                    <div class="sin__desc">
                            ...
                            <div class="pro__tab__content__inner">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        @if ($checkCmt)
                                            <div class="stars">
                                                <form>
                                                    ...
                                                    <textarea style="background: #fff; min-width: 260px; border: none"
                                                              name="comment_customer" cols="30" rows="5"
                                                              placeholder="Viết bình luận của bạn ở đây"></textarea>
                                                    <ul class="payment__btn mt-0">
                                                        <li>
                                                            <button type="button" class="btn form-control btn-comment"
                                                                    data-product_id="{{$data->product_id}}">Gửi bình
                                                                luận
                                                            </button>
                                                        </li>
                                                    </ul>
                                        ...
                                        @else
                                            <span
                                                class="text-danger">Bạn cần đăng nhập và mua sản phẩm để bình luận</span>
                                        @endif
                                        ...
                                        <div class="comment-list">
                                            ...
                                            @foreach ($dataComment as $item)
                                                <div class="single-comment">
                                                    <p><span
                                                            class="text-danger">{{date('d/m/Y',strtotime($item->created_at))}} {{$item->user->user_name}}
                                                            @php
                                                                $rating = '';
                                                    ...
                                                    @if ($item->comment_admin != '')
                                                        <p><span
                                                                class="text-danger">--Trả lời từ Admin:</span> {{$item->comment_admin}}
                                                        </p>
                                                    @endif
                                                </div>
                                                <hr>
