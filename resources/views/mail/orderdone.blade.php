<div class="container" style="max-width: 700px;margin: 0 auto; border: 1px solid #c43b68;">
    <div class="header" style="background-color: #c43b68; color: #fff; padding: 15px;">
        <h3 style="font-size: 20px; text-align: center">ĐẶT HÀNG THÀNH CÔNG TẠI - APPLE-123</h3>
        <h4>Xin Chào {{$dataUser->user_name}}</h4>
        <p>Cảm ơn bạn đã đặt hàng ở APPLE-123</p>
    </div>
    ...
    <br>
    <div class="footer"
         style="font-size: 15px; text-align: center; background-color: #c43b68; color: #fff; padding: 10px;">
        <p>Đây là tin nhắn tự động từ APPLE-123 - Vui lòng không trả lời tin nhắn này</p>
        <p>Mọi thắc mắc về đơn hàng hãy liên hệ đến APPLE-123 ở phần liên hệ</p>
        <p>APPLE-123 Xin Cảm Ơn Quý Khách Hàng</p>
    </div>
</div>
